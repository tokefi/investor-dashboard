									...
									<div class="row" id="section-1">
										<div class="col-md-12">
											<div>
												...
												<input required type="number" name="apply_for" class="form-control" placeholder="" @if(isset($eoi)) value="{{number_format(round($eoi->investment_amount * $project->share_per_unit_price, 2))}}" @endif @if(isset($clientApplication)) value="{{round($clientApplication->investment_amount * $project->share_per_unit_price) }}" @endif style="width: 60%;" id="application_money" step="0.01" min="{{$project->investment->minimum_accepted_amount * $project->share_per_unit_price}}"><br>
