...
<head>
  ...
  <title>Please sign in to accept request</title>
        ...
        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" width="100%" class="mcnTextContentContainer">
          <tbody><tr>
            ...
            <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;font-size: 14px;font-style: normal;font-weight: normal;line-height: 100%;text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;">
              ...
              <br> <br>
              <strong><span style="color:@if($siteColor=App\Helpers\SiteConfigurationHelper::getSiteThemeColors())#{{$siteColor->heading_color}}@else #282a73 @endif"><span style="font-family:helvetica; font-weight:bolder; line-height:21px"><span style="font-size:20px">Dear {{$clientApplication->client_first_name}},</span></span></span></strong>

              <div style="font-size: 13px;text-align:left; font-family:'Helvetica';font-weight:lighter;line-height:21px;"><br>
                <span style="color:#"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px">{{$agent->first_name}} {{$agent->last_name}} has submitted an application to {{$project->title}} on behalf of you for {{$clientApplication->investment_amount}}.<br><br>
                  To sign off on it please click here<br><br>
    ...
    <tr>
      <td style="padding-top: 0;padding-right: 18px;padding-bottom: 18px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;" valign="top" align="left" class="mcnButtonBlockInner">
        <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 0px;background-color:@if($siteColor=App\Helpers\SiteConfigurationHelper::getSiteThemeColors())@if($siteColor->heading_color)#{{$siteColor->heading_color}}@else #2d2d4b @endif @else #2d2d4b @endif;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
          <tbody>
            <tr>
              @if(isset($agent->eoi_token))
              <td>
                <strong><span style="color: #282a73;"><span style="font-family:helvetica; font-weight:bolder; line-height:21px"><span style="font-size:20px;background-color: #fff !important; ">{{$agent->eoi_token}}</span></span></span></strong>
              </td>
              @else
              <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;font-size: 16px;padding: 10px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                ...
                <a class="mcnButton" title="Please sign in" href=" {{route('projects.interest', $project)}}?source=clientApplication&id={{$clientApplication->id}}" target="_blank" style="font-weight: normal;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;display: block;">Sign</a>
              </td>
              @endif
            </tr>
          </tbody>
