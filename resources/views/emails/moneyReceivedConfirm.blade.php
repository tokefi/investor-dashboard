          ...
          <tbody><tr>
            ...
            <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif;font-size: 14px;font-style: normal;font-weight: normal;line-height: 100%;text-align: left;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;">
              ...
              <div style="font-size: 13px;text-align:justify; font-family:'Helvetica';font-weight:lighter;line-height:21px;"><br>
                <span style="color:#"><span style="font-size:14px"><span style="font-family:helvetica; font-weight:lighter; line-height:21px">Thank you for your application into the {{$investment->project->title}} project. We are pleased to confirm that we have received ${{number_format(round($investment->amount * $investment->buy_rate, 2))}} for this project.<br><br>
                  <span style="color:#">Once the fund raising process is complete, we will issue you a share certificate denoting your investment into the project and you will receive regular updates as the project progresses.</span><br><br><span style="color:#">If you have any questions, please contact your client relationship manager and they will be able to assist you with any enquiries you may have.</span><br><br><span style="color:#">Kind regards,</span>
                  &nbsp;
