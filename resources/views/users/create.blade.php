...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<br><div class="alert alert-warning"><strong>Notice: </strong>The signup process is temporarily suspended. Please contact admin for further information.</div>	
		</div>
	</div>
	@endif
	<div class="row">
				...
				<div class="col-md-12">
					...
					@if(Session::has('errors'))
						@if($errors->has('signup'))
							{!! $errors->first('signup', '<div class="alert alert-danger"><strong>Error! </strong>:message</div>') !!}
						@endif
					@endif
