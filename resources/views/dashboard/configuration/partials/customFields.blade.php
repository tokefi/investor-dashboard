                    ...
                    <div class="col-sm-4" style="margin-bottom: 20px;">
                        ...
                        <div class="col-sm-4" style="margin-bottom: 20px;">
                            ...
                            <div class="col-sm-4" style="margin-bottom: 20px;">
                                ...
                                <div class="col-sm-4 hide checkboxName" style="margin-bottom: 20px;">
                                    <label for="label">Checkbox Name<sup class="text-danger">*<sup></label>
                                        <input type="text" class="form-control" id="checkboxName" name="checkboxName" placeholder="Enter label" >
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <label for="is_conditional">Is Conditional ?</label>
                                    </div>
                                    <div class="col-sm-12">
                        ...
                        <table class="table table-borderless table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <td>@if($customField->type !== 'checkbox' && $customField->is_conditional) @foreach($customCheckboxs as $customCheckbox) <input type="{{ $customCheckbox->type }}" name="is_conditional_{{ $customCheckbox->label }}" class="is_conditional" checkbox-id="{{ $customCheckbox->id }}" field-id="{{ $customField->id }}" @if(null !== $customField->isConditional->where('custom_checkbox_id',$customCheckbox->id)->first()) @if($customField->isConditional->where('custom_checkbox_id',$customCheckbox->id)->first()->is_linked) checked @endif @endif > {{ $customCheckbox->label }} <br>@endforeach @endif </td>
