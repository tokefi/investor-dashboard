											...
											<div class="row form-group">
												...
												<div class="row">
													<div class="col-md-12 " style="visibility: visible !important;">
														...
														<button type="button" class='btn btn-lg btn-danger font-semibold text-right second_color_btn' id="submitform"  style="width:243px; background-color: #fed405; font-size:1em; color:#000;border-radius:50px; border: 0px;"><img class="pull-left" src="{{asset('assets/images/konkrete_favicon.png')}}" style="width: 20px;"> Register</button>
													</div>
