									...
									<section id="loginForm" style="padding:0 10px;">
										...
										<fieldset>
											...
											<div class="form-group" style="width:75%;">
												...
												<button type="submit" class='btn btn-lg btn-danger font-semibold text-right font_color' id="submitformlogin" href='#' style="width:300px; background-color: #fed405; font-size:1em; color:#000;border-radius:50px; border: 0px;" data-toggle="tooltip" title="If you are an existing Konkrete user you can use the same username and password here without having to sign up again"><img class="pull-left @if(!App\Helpers\SiteConfigurationHelper::getConfigurationAttr()->show_powered_by_estatebaron) hide @endif" src="{{asset('assets/images/konkrete_favicon.png')}}" style="width: 20px;"> Login @if(App\Helpers\SiteConfigurationHelper::getConfigurationAttr()->show_powered_by_estatebaron) with Konkrete account @endif </button>
											</div>
