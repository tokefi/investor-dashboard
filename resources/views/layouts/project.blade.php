        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item" ><a href="{{route('home')}}#projects" class="font-color">Investments</a></li>
                    @if($siteConfiguration->show_funding_options != '')
                    <li class="nav-item" ><a href="{{route('home')}}#funding" class="font-color">Funding</a></li>
                    @endif
                    <li class="nav-item"><a href="/pages/team" class="font-color" class="font-color">About us</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 text-center">
                            <ul class="list-inline footer-list " data-wow-duration="1.5s" data-wow-delay="0.4s" style="margin:0px;">
                                ...
                                <li class="footer-list-item @if(!$siteConfiguration->blog_link_new == ' NULL ') hide @endif"><a href="{{$siteConfiguration->blog_link_new}}" target="_blank" style="color:#fff;" class="a-link font-color"><span class="font-semibold" style="font-size: 16px;">Blog</span></a></li>
                        <!-- @if($siteConfiguration->show_funding_options != '')
...
<!--                     <span style="margin:0 0 1px;">
        ...
        <div class="row text-center @if(!App\Helpers\SiteConfigurationHelper::getConfigurationAttr()->show_powered_by_estatebaron) hide @endif" style="padding-top: 20px;">
          ...
          <p>
            <span style="" class="font-color">Built on </span><a href="https://konkrete.io" target="_blank" style="cursor: pointer; " class=" font-color">Konkrete</a>
        </p>
    </div>
    <br>
    <p class="font-color text-center" style="font-size:16px;">
